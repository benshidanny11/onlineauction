...
<?php 
                    ...
                    <div class="box" id="contact">
                        ...
                        if(isset($_GET['err'])) {
                            echo '
                                    <div class="alert alert-info">
                                         <strong>Sorry!</strong> You need to <a href="register.php">log in</a> to add a product.
                                    </div>
                                    ';
                        }
                        ?>
                        ...
                        <form class="form-horizontal" action="process_add_product.php" enctype="multipart/form-data" method="POST">
						...
						1. What to do you want to sell or auction? 
						...
						2. Tell more about your product.
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse">
                                    ...
                                    <label class="control-label col-sm-2" >Images :</label>
                                         <div class="col-sm-10">
                                         <input type="file" name="PhotosID" class="form-control" id="chooseFile">
                                ...
                                <div id="collapseThree" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <label class="control-label col-sm-2" >Starting Price:</label>
                                         <div class="col-sm-10">
                                       <input type="text" class="form-control" name="StartingPrice" placeholder="Enter the Starting Value in Rwandan francs">
                                       <br>
                                        </div>

                                       <label class="control-label col-sm-2" for="comment">Expected Price:</label>
                                        <div class="col-sm-10">
                                       <input type="text" class="form-control" name="ExpectedPrice" placeholder="Enter the Expected Value in Rwandan francs">
                                       <br>
                                        </div>
                        ...
                        <br>
                         ...
                         <input type="submit" align ="left" class="btn btn-primary center-block"  value="Add prouct">
