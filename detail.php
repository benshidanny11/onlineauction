                    ...
                    <div class="row" id="productMain">
                        ...
                        <div class="col-sm-6">
                            <div class="box">
                                ...
                                <p class="price">Current Bid : RWF <?php echo  number_format($row['CurrentPrice'],2);?></p>
                                 ...
                                 <form action="" method="post" align="center">
									...
									<p align="center">Enter a value greater than RWF <?php echo number_format($leastValue,2);?> </p>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="product same-height">
                                ...
                                <div class="text">
                                    ...
                                    <p class="price">RWF : <?php echo number_format($row2['CurrentPrice'],2);?></p>
                                </div>
                            </div>
                            <!-- /.product -->
                        </div>
